...
const larrow = new Proxy({"src":"/_astro/icon3.C2Kx7sAW.svg","width":21,"height":20,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/k1960/OneDrive/デスクトップ/HP制作（仕事用）/HamadaRyo/src/assets/icon3.svg";
							}
...
const HeroIlust = new Proxy({"src":"/_astro/hero.Cc0GD7y9.svg","width":601,"height":515,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/k1960/OneDrive/デスクトップ/HP制作（仕事用）/HamadaRyo/src/assets/pics/hero.svg";
							}
...
const linkd = new Proxy({"src":"/_astro/profile-in.CjyVQDgO.svg","width":34,"height":34,"format":"svg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/k1960/OneDrive/デスクトップ/HP制作（仕事用）/HamadaRyo/src/assets/pics/profile-in.svg";
							}
